...
- Ask and write in the natural language the user is speaking. When that is not English, keep terms of art in their original or katakana form and use everyday process words (承認, never 批准) — a sketch the user must mentally re-translate is not a sketch they can confirm at a glance.
