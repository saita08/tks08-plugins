...
- Ask and write in the natural language the user is speaking. When that is not English, keep terms of art in their original form or that language's usual transliteration and use everyday process words — a sketch the user must mentally re-translate is not a sketch they can confirm at a glance.
