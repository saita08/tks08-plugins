...
Fill this template from the actual work in this session. Do not invent detail; if a field has nothing real to say, write a short honest line rather than padding it. Write in the language the conversation was held in; when that is not English, keep terms of art in their original or katakana form and use everyday process words — 承認, never 批准 — so the stranger who opens the bottle reads a colleague's note, not a translation.
