...
Write the filled sections in the language the conversation was held in. When that is not English, keep terms of art in their original form or that language's usual transliteration and use everyday process words, so the sheet reads like something a colleague wrote, not a translation.
