...
4. **Commit after each fix** with a commit message that describes what was fixed and why. Write plans, reports, and commit messages in the language the review feedback is written in; when that is not English, keep terms of art in their original or katakana form and use everyday process words (承認, never 批准). Why: commit messages persist in the repository's history, and a calqued term written by one teammate becomes house style for every later reader
